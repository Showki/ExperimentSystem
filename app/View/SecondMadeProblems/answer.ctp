...
<?php
echo $this->Form->create('SecondMadeProblem',array(
...
echo $this->Form->hidden('SecondMadeProblem.times',array('value' => $times));
echo $this->Form->hidden('SecondMadeProblem.id',array('value' => $problem['SecondMadeProblem']['id']));	
